...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义
#define Switch_Address_0(i) ((i)?(HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12,GPIO_PIN_SET)) : (HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12,GPIO_PIN_RESET)))// 地址位0控制

#define Switch_Address_1(i) ((i)?(HAL_GPIO_WritePin(GPIOB, GPIO_PIN_13,GPIO_PIN_SET)) : (HAL_GPIO_WritePin(GPIOB, GPIO_PIN_13,GPIO_PIN_RESET)))// 地址位1控制

#define Switch_Address_2(i) ((i)?(HAL_GPIO_WritePin(GPIOA, GPIO_PIN_12,GPIO_PIN_SET)) : (HAL_GPIO_WritePin(GPIOA, GPIO_PIN_12,GPIO_PIN_RESET)))// 地址位2控制
